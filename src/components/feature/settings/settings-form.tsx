        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <InputGroup>
              ...
              <Input
                ...
                value={user?.email || ""}
                disabled
                className="bg-muted/50 border-0 shadow-none focus-visible:ring-0"
              />
            </InputGroup>
          ...
          <div className="space-y-2">
            ...
            {formData.profileImage && (
              <div className="bg-muted/30 border-border mt-2 rounded-lg border p-2">
                <Image
          ...
          <div className="space-y-2">
            ...
            <InputGroup>
              <Input
                ...
                disabled
                className="bg-muted/50 border-0 capitalize shadow-none focus-visible:ring-0"
              />
            </InputGroup>
          </div>
          ...
          {/* Submit Button */}
          <Button type="submit" disabled={saving} className="bg-primary hover:bg-primary/90 w-full">
            {saving ? (
              <>
